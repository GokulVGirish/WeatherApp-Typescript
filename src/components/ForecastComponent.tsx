...
import { getHumidityValue,getPop,getVisibilityValue } from "../helpers"
type props={
    data:foreCastType
}
    ...
    <div className="w-full md:max-w-[500px] py-4 md:py-4 md:px-10 lg:px-24 h-full lg:h-auto bg-white bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg">
        ...
        <div className="mx-auto w-[300px]">
            <section className="text-center">
                ...
                <p className="text-sm">{today.weather[0].main}

                    {today.weather[0].description}
                </p>
                <p className="text-sm">
                 H:<Degree temp={Math.round(today.main.temp_max)}/> L:<Degree temp={Math.ceil(today.main.temp_min)}/>
                </p>

            </section>
            <section className="flex overflow-x-scroll mt-4 mb-5">
                {
